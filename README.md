...
| FAIRY2I: Universal Extremely-Low Bit QAT framework via Widely-Linear Representation and Phase-Aware Quantization | 2025 | Transforms real-valued LLMs to widely-linear complex form for 1-2 bit QAT; uses {±1, ±i} codebook and recursive residuals; matches FP16 on LLaMA-2 7B. | Novel algorithms, Quantization, Training paradigms                     | [Paper](https://arxiv.org/abs/2512.02901) |
...
| Title                          | Year | Author(s)    | Description                                                                                                                | Key Highlights                                                                                                                                  | Label(s)                                                         | URL                                                             |
| ------------------------------ | ---- | ------------ | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- | --------------------------------------------------------------- |
| **AI Performance Engineering** | 2025 | Chris Fregly | Comprehensive guide to understanding, benchmarking, profiling, and optimizing AI workloads across hardware and frameworks. | Covers performance tuning across CPU, GPU, and TPU; includes end-to-end AI system optimization, profiling tools, and deployment best practices. | Hardware optimization techniques, Deployment, Training paradigms | [GitHub](https://github.com/cfregly/ai-performance-engineering) |
...
* For books/resources, include the title, author(s), year, short description, highlights, and applicable labels.
